...
{
	MODULEINFO hModInfo;
	GetModuleInformation(GetCurrentProcess(), GetModuleHandleA(NULL), &hModInfo, sizeof(hModInfo));
	return PatternScanner::FindPattern(GetModuleHandleA(NULL), hModInfo.SizeOfImage, pattern);
}
